particlesJS('particles-js',
  ...
  "particles": {
    ...
    "shape": {
      ...
      "image": {
          "src": "", // 原子的图片可以使用自定义图片 "assets/img/yop.svg" , "http://mywebsite.com/assets/img/yop.png"
          "width": 100, //图片宽度
          "height": 100 //图片高度
      }
    },
    ...
    "move": {
      "enable": true, //原子移动
      "speed": 5, //原子移动速度
      "direction": "bottom-right", //原子移动方向   "none" ,"top" ,"top-right" ,"right" ,"bottom-right" ,"bottom" ,"bottom-left" ,"left" ,"top-left"
      "random": true, //移动随机方向
      "straight": false, //直接移动
